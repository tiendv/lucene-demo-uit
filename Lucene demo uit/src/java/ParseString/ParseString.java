...
*/
    public static void main(String[] args) throws IOException {
        ...
        String Parse2 = "[)]+";
        String[] st = null;
        //String word = "  multi (timel) big key=(time delay) org=() org=(Microsoft) jour=(Journal of The ACM) conf=(SIGGRAPH) author=(Bill Gates) long (time) many year=2000 year>=2006 year<=2011";
