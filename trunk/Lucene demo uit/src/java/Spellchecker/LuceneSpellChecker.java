...
public class LuceneSpellChecker {
    ...
    public void addToDictionary(String dictionaryEntry, String objectType) throws IOException {
        Document doc = new Document();
        doc.add(new Field("word", dictionaryEntry, Store.YES, Index.ANALYZED));
        doc.add(new Field("objectType", objectType, Store.YES, Index.ANALYZED));
        AnalysisResult result = analyze(dictionaryEntry.toLowerCase());
